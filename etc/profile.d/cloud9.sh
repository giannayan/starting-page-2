...
export C9_FULLNAME='Gianna Yan'
export C9_HOSTNAME='starting-page-giannayan.c9users.io'
export C9_EMAIL='giannayan1@gmail.com'
export C9_USER='giannayan'
export C9_PROJECT='starting-page'
export C9_PID='6465514'
export C9_UID='1926043'
